...
class OnlineSearch(QueryExtractorLangchain):
    ...
    def run(self, history: List[Message] = [], **kwargs):
        ...
        text_results, _ = super().run(HUMAN_TEMPLATE, history, streaming=False, **param_query_extractor)
...
#         }
#     ]
#     answer = chain.run(history=history, question="", context="")
